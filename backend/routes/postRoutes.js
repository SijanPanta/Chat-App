 ...
 *                 type: string
 *                 format: binary
 *                 description: Optional image file (jpeg, jpg, png, gif, webp — max 5MB)
 *               categories:
 *                 type: string
 *                 description: JSON stringified array of category labels
 ...
 *       400:
 *         description: Validation error or invalid image content
 *         content:
 *           application/json:
 *             schema:
 ...
 *     responses:
 *       200:
 *         description: Paginated list of posts by the user
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/PaginatedPosts'
